...
class IntroFragment : Fragment() {
    ...
    private val introPages = listOf(
        IntroItem(R.drawable.ic_unknown, R.string.intro_about),
        IntroItem(R.drawable.ic_unknown, R.string.intro_settings),
        IntroItem(R.drawable.ic_unknown, R.string.intro_routes),
